...
esp_err_t add(endpoint_t *endpoint, config_t *config)
{
    ...
    VerifyOrReturnValue(identify != NULL, ESP_FAIL, ESP_LOGE("dimmable_plug_in_unit", "Failed to create cluster: identify"));
    ...
    VerifyOrReturnValue(on_off != NULL, ESP_FAIL, ESP_LOGE("dimmable_plug_in_unit", "Failed to create cluster: on_off"));
    ...
    VerifyOrReturnValue(level_control != NULL, ESP_FAIL, ESP_LOGE("dimmable_plug_in_unit", "Failed to create cluster: level_control"));
    ...
    VerifyOrReturnValue(scenes_management != NULL, ESP_FAIL, ESP_LOGE("dimmable_plug_in_unit", "Failed to create cluster: scenes_management"));
